    ...
    <div className="container" style={{ padding: "60px 20px" }}>
      <div className={styles.header}>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: "1.2rem", maxWidth: "700px", margin: "0 auto" }}>
          Whether you're visiting our local clinics or ordering through our international dropshipping infrastructure, we're here to help you achieve your natural glow.
        </p>
      </div>
      ...
      <div className={styles.contactGrid}>
        ...
        <div className={`glass-panel animate-fade-up ${styles.infoPanel}`}>
          ...
          <p style={{ color: "var(--text-muted)", marginBottom: "30px" }}>
            Reach out to our global team at EL Health and Wellness (EL Glamorous Face and Body Clinic).
          </p>
          ...
          <div className={styles.infoItem}>
            ...
            <div>
              ...
              <p>Monday - Friday: 9:00 AM – 7:00 PM (EDT)</p>
            </div>
          </div>
        </div>
